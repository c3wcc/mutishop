...
class UserController extends BaseController {
    ...
    public function index(){
		 $this->assign('first_leader1',$_GET['first_leader']);
		 $this->assign('second_leader1',$_GET['second_leader']);
		 $this->assign('third_leader1',$_GET['third_leader']);
        $this->display();
    }
    ...
    public function ajaxindex(){
        ...
        I('second_leader') ? $condition['second_leader'] = I('second_leader') : false; // 查看二级下线人有哪些
        I('third_leader') ? $condition['third_leader'] = I('third_leader') : false; // 查看三级下线人有哪些
