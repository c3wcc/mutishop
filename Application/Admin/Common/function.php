...
function getAllMenu(){
	return	array(
			...
			'article' => array('name' => '文章管理', 'icon'=>'fa-file', 'sub_menu' => array(
			...
			'goods' => array('name' => '商品管理', 'icon'=>'fa-tasks', 'sub_menu' => array(
			        //array('name' => '发布商品', 'act'=>'addEditGoods', 'control'=>'Goods'),
					array('name' => '商品类目', 'act'=>'categoryList', 'control'=>'Goods'),
					array('name' => '全部商品', 'act'=>'goodsList', 'control'=>'Goods'),
					array('name' => '审核商品', 'act'=>'examineGoodsList', 'control'=>'Goods'),
			...
			'Store' => array('name' => '店铺管理', 'icon'=>'fa-home', 'sub_menu' => array(
					array('name' => '店铺申请列表', 'act'=>'apply_list', 'control'=>'Store'),
			...
			'distribut' => array('name' => '分销管理', 'icon'=>'fa-cubes', 'sub_menu' => array(
					...
					array('name' => '提现申请', 'act'=>'withdrawals', 'control'=>'Finance'),
