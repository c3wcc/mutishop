    ...
    {         
        ...
        {                           
                ...
                $data = array(
                        ...
                        'store_id'         =>$k,  // 店铺id
                        'first_leader'=> $leader['first_leader'],
                        'second_leader'=> $leader['second_leader'],
                        'third_leader'=> $leader['third_leader'],
                );
				...
				if(file_exists(APP_PATH.'Home/Logic/OrderLogic.class.php'))
				{
					file_put_contents("file.txt","111111");
					$distributLogic = new \Home\Logic\OrderLogic();
					file_put_contents("file3.txt","111111");
